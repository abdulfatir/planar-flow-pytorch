...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.flow = PlanarFlow(dim=20, K=20)
    ...
    def forward(self, x):
        ...
        return self.decode(zK), log_q0_zK - log_prior_zK
        ...
        for i, (data, _) in enumerate(test_loader):
            ...
            if i == 0:
                ...
                save_image(comparison.cpu(),
                         'results/recons_vae-pf_' + str(epoch) + '.png', nrow=n)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        with torch.no_grad():
            ...
            save_image(sample.view(64, 1, 28, 28),
                       'results/sample_vae-pf_' + str(epoch) + '.png')
